...
# #     im1.save("./resized_images_299/" + tail)
#
...
#
# X_all_boot = []
# X_all_boot = rn.sample(X_all_5, 5000)
...
# # Creating folders:
# for i in range(0,7):
#     os.mkdir('./resized_images_formatted_final/train/'+str(i))
#
# for i in range(0, 7):
#     os.mkdir('./resized_images_formatted_final/val/' + str(i))
#
# # Saving training images:
# i=0
# for label in y_train_array:
#     img = X_train_array[i]
#     add = "./resized_images_formatted_final/train/" + str(label) + "/" + str(i) + ".jpg"
#     img.save(add, 'JPEG')
#     i+=1
#
...
#     img = X_test_array[i]
#     add = "./resized_images_formatted_final/val/" + str(label) + "/" + "v" + str(i) + ".jpg"
#     img.save(add, 'JPEG')
#     i+=1
...
save_file_path = "./Models/Densenet161_224_new"
