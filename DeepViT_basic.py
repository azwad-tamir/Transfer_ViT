...
torch.save(model.state_dict(), './final_models_simple/DeepViT_model.pth')
metrices = [train_loss_list, val_loss_list, train_acc_list, val_acc_list]
with open("./final_models_simple/DeepViT_metrices.pk", "wb") as fp:   #Pickling
...
# loading model:
# model.load_state_dict(torch.load("./final_models_simple/DeepViT_model.pth"))
model.eval()
...
with open("./final_models_simple/DeepViT_predictions.pk", "wb") as fp:   #Pickling
...
# with open('./final_models_simple/deepViT_metrices.pk', 'rb') as f:
...
# with open('./final_models_simple/deepViT_predictions.pk', 'rb') as f:
...
plt.title("Confusion matrix for DeepViT model")
plt.show()