...
torch.save(model.state_dict(), './final_models_simple/T2TViT_model.pth')
metrices = [train_loss_list, val_loss_list, train_acc_list, val_acc_list]
with open("./final_models_simple/T2TViT_metrices.pk", "wb") as fp:   #Pickling
...
# loading model:
# model.load_state_dict(torch.load("./final_models_simple/T2TViT_model.pth"))
model.eval()
...
with open("./final_models_simple/T2TViT_predictions.pk", "wb") as fp:   #Pickling
...
# with open('./final_models_simple/T2TViT_metrices.pk', 'rb') as f:
...
# with open('./final_models_simple/T2TViT_predictions.pk', 'rb') as f:
...
plt.title("Confusion matrix for T2TViT model")
plt.show()